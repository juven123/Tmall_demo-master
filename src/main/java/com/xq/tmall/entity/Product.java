...
public class Product {
    ...
    public Product(Integer product_id, String product_name, Double product_sale_price, Date product_start_time,Date product_end_time,Category product_category, Byte product_isEnabled) {
    ...
    public String getProduct_start_time() {
        if(product_start_time != null){
            SimpleDateFormat time=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss",Locale.UK);
            return time.format(product_start_time);
        }
        return null;
    }
    ...
    public Product setProduct_start_time(Date product_start_time) {
        this.product_start_time = product_start_time;
        return this;
    }
    ...
    public String getProduct_end_time() {
        if(product_end_time != null){
            SimpleDateFormat time=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss",Locale.UK);
            return time.format(product_end_time);
        }
        return null;
    }

    public Product setProduct_end_time(Date product_end_time) {
        this.product_end_time = product_end_time;
        return this;
    }

    public Integer getProduct_keep_sum() {
        return product_keep_sum;
    }

    public Product setProduct_keep_sum(Integer product_keep_sum) {
        this.product_keep_sum = product_keep_sum;
        return this;
    }
